...
**Input Form**
![Resume Analyzer Input](resume-analyser/src/main/resources/static/screenshot.png)

**Analysis Result**
![Resume Analyzer Result](resume-analyser/src/main/resources/static/screenshot2.png)
